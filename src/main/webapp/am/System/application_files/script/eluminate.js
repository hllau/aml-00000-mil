...
function cmMakeTag(__v) {
	...
	if (cm.tid == "6") {
		...
		document.cookie = "http://www.asiamiles.com/am/en/redeem/cmTPSet=Y; path=/";
	}
...
function cmGetDefaultPageID() { 
	...
	var slashPos = pageName.lastIndexOf("http://www.asiamiles.com/");
	if (slashPos == pageName.length - 1) {
		pageName = pageName + "default";
	}

	while (pageName.indexOf("http://www.asiamiles.com/") == 0) {
...
var _a="http://www.asiamiles.com/am/en/redeem/io_config.js";
var _b="V4";
...
try{
this.xmlHttp.open("http://www.asiamiles.com/am/en/redeem/GET",this.url,true);
}
catch(e){
...
IORequest.url_prefix["ajax remote"]="http://www.asiamiles.com/limelight/";
...
IORequest.i_zone=0;
IORequest.stack_manager("http://www.asiamiles.com/am/en/redeem/chris.html");
}else{
